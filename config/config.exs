...
config :transitmaps, TransitmapsWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: TransitmapsWeb.ErrorHTML, json: TransitmapsWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Transitmaps.PubSub,
  live_view: [signing_salt: "vAydN76J"]
...
config :transitmaps, Transitmaps.Mailer, adapter: Swoosh.Adapters.Local
